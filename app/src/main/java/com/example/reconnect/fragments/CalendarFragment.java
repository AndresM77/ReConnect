...
public class CalendarFragment extends Fragment {
    ...
    public void launchCamera() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(getContext(), "com.example.reconnect", photoFile);
    ...
    public File getPhotoFileUri(String fileName) {
        ...
        File mediaStorageDir = new File(getActivity().getExternalFilesDir(Environment.DIRECTORY_PICTURES), "ProfileActivity");
    ...
    public void saveUser (final File photoFile) {
